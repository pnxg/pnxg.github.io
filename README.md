...
[https://pnxg.github.io/manifest.json](https://pnxg.github.io/manifest.json)

as the [Add-on Repository URL](https://github.com/pnxg/pnxg.github.io/blob/main//README.md#dont-know-where-to-add-the-add-on-repository-url)
...
```
git clone --recursive https://github.com/pnxg/pnxg.github.io/
...
In which case, we'll use `https://stremio-static-addon-example-ijshgdlgoe.now.sh/manifest.json` as the [Add-on Repository URL](https://github.com/pnxg/pnxg.github.io/blob/main//README.md#dont-know-where-to-add-the-add-on-repository-url) to load our add-on in Stremio
...
This example add-on can be found at [stremio-express-static-addon](https://github.com/pnxg/pnxg.github.io/).
